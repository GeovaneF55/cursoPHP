...
class OilPressure extends CarStatus
{
  ...
  {
    if ($car->oil != "OK") {
      echo "Oil Pressure is not OK.<br>";
    } else {
      echo "Oil Pressure is OK.<br>";
    }
...
class FuelLevel extends CarStatus
{
  ...
  {
    if ($car->fuel != "OK") {
      echo "Fuel Level is not OK.<br>";
    } else {
      echo "Fuel Level is OK.<br>";
    }
...
class BreakFluid extends CarStatus
{
  ...
  {
    if ($car->break != "OK") {
      echo "Break Fluid is not OK.<br>";
    } else {
      echo "Break Fluid is OK.<br>";
    }
